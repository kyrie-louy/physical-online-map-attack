...
from .train_blind_attack import single_gpu_attack_camera_blind
from .train_patch_attack import single_gpu_attack_patch
...
__all__ = [
    ...
    'single_gpu_attack_camera_blind', 'single_gpu_attack_patch'
]
