...
WB = CONFIG['vehicle']['wheelbase']
W = CONFIG['vehicle']['width']
LF = CONFIG['vehicle']['front_length']
LB = CONFIG['vehicle']['back_length']
MAX_STEER = CONFIG['vehicle']['max_steering_angle']
### read yaml file ###
